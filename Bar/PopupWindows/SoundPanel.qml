...
Tooltip {
    ColumnLayout {
        ...
        Repeater {
            model: ScriptModel {
                values: Pipewire.nodes.values.filter(n => n.audio !== null && n.isStream && n.isSink)
            }
            ...
            Rectangle {
                ...
                Layout.fillWidth: true
                Layout.preferredHeight: nodeColumn.implicitHeight + 10
                ...
                PwObjectTracker { 
                    ...
                    onObjectsChanged: {
                        node.modelData = Pipewire.nodes.values.filter(n => n.audio !== null && n.isStream && n.isSink)[node.index]
                    }
                }
